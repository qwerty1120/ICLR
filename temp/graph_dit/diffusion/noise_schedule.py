...
class PredefinedNoiseScheduleDiscrete(torch.nn.Module):
    def __init__(self, noise_schedule, timesteps):
        ...
        elif noise_schedule == 'poly':
            betas = diffusion_utils.polynomial_beta_schedule_discrete(timesteps)*0.05
        elif noise_schedule == 'linear':
            betas = diffusion_utils.linear_beta_schedule_discrete(timesteps)
        elif noise_schedule == 'ddim':
            betas = diffusion_utils.ddim_beta_schedule_discrete(timesteps)
        elif noise_schedule == 'sigmoid':
            betas = diffusion_utils.sigmoid_beta_schedule_discrete(timesteps)
        elif noise_schedule == 'expo':
            betas = diffusion_utils.exponential_beta_schedule_discrete(timesteps)
        elif noise_schedule == 'clipcosine':
            betas = diffusion_utils.clipcosine_beta_schedule_discrete(timesteps)*0.05
        elif noise_schedule == 'scaled_cosine':
            betas = diffusion_utils.scaled_cosine_beta_schedule_discrete(timesteps)
        elif noise_schedule == 'scaled_poly':
            betas = diffusion_utils.scaled_poly_beta_schedule_discrete(timesteps)
        else:
